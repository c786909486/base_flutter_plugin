...
Widget createInput(String text, ITextFieldCallBack fieldCallBack,
  ...
  return ITextField(
    ...
    hintStyle: TextStyle(fontSize: 28.0, color: Color(0xFF646566)),
  ...
  //   focusNode: node,
  //   style: TextStyle(color: ColorRes.text_black, fontSize: 28.0),
  //   decoration: InputDecoration(
  //     hintText: hintText,
  //     border: OutlineInputBorder(borderSide: BorderSide.none),
  //     hintStyle:
  //     TextStyle(fontSize: 28.0, color: ColorRes.item_title_color),
  //   ),
  //   textAlign: TextAlign.right,
  // )
}
